12313iguration file for jupyter-notebook.
...
#12313igure additional log handlers.
#  
...
#  Default: False
12otebookApp.allow_credentials = False
...
#  the UI/API.
#  Default: True
12otebookApp.allow_password_change = True
...
#  Default: False
12otebookApp.allow_remote_access = False

## Whether to allow the user to run the notebook as root.
#  Default: False
12otebookApp.allow_root = False

## Answer yes to any prompts.
#  See also: JupyterApp.answer_yes
12otebookApp.answer_yes = False

## "
#          Require authentication to access prometheus metrics.
#  Default: True
12otebookApp.authenticate_prometheus = True

## Reload the webapp when changes are made to any Python src files.
#  Default: False
12otebookApp.autoreload = False

## DEPRECATED use base_url
#  Default: '/'
12otebookApp.base_project_url = '/'
...
#  Default: ''
12otebookApp.browser = ''

## The full path to an SSL/TLS certificate file.
#  Default: ''
12otebookApp.certfile = ''

## The full path to a certificate authority certificate for SSL/TLS client
#  authentication.
#  Default: ''
12otebookApp.client_ca = ''

## Full path of a config file.
#  See also: JupyterApp.config_file
12otebookApp.config_file = ''

## Specify a config file to load.
#  See also: JupyterApp.config_file_name
12otebookApp.config_file_name = ''

## The config manager class to use
#  Default: 'notebook.services.config.manager.ConfigManager'
12otebookApp.config_manager_class = 'notebook.services.config.manager.ConfigManager'

## The notebook manager class to use.
#  Default: 'notebook.services.contents.largefilemanager.LargeFileManager'
12otebookApp.contents_manager_class = 'notebook.services.contents.largefilemanager.LargeFileManager'

## Extra keyword arguments to pass to `set_secure_cookie`. See tornado's
#  set_secure_cookie docs for details.
#  Default: {}
12otebookApp.cookie_options = {}
...
#  Default: b''
12otebookApp.cookie_secret = b''

## The file where the cookie secret is stored.
#  Default: ''
12otebookApp.cookie_secret_file = ''
...
#  Default: ''
12otebookApp.custom_display_url = ''

## The default URL to redirect to from `/`
#  Default: '/tree'
12otebookApp.default_url = '/tree'
...
#  Default: False
12otebookApp.disable_check_xsrf = False
...
#  source.
#  Default: True
12otebookApp.enable_mathjax = True

## extra paths to look for Javascript notebook extensions
#  Default: []
12otebookApp.extra_nbextensions_path = []

## handlers that should be loaded at higher priority than the default services
#  Default: []
12otebookApp.extra_services = []
...
#  Default: []
12otebookApp.extra_static_paths = []

## Extra paths to search for serving jinja templates.
#  
#          Can be used to override templates from notebook.templates.
#  Default: []
12otebookApp.extra_template_paths = []

#  Default: ''
12otebookApp.file_to_run = ''

## Generate default config file.
#  See also: JupyterApp.generate_config
12otebookApp.generate_config = False

## Extra keyword arguments to pass to `get_secure_cookie`. See tornado's
#  get_secure_cookie docs for details.
#  Default: {}
12otebookApp.get_secure_cookie_kwargs = {}

## Deprecated: Use minified JS file or not, mainly use during dev to avoid JS
#  recompilation
#  Default: False
12otebookApp.ignore_minified_js = False

## (bytes/sec)
#          Maximum rate at which stream output can be sent on iopub before they are
#          limited.
#  Default: 1000000
12otebookApp.iopub_data_rate_limit = 1000000

## (msgs/sec)
#          Maximum rate at which messages can be sent on iopub before they are
#          limited.
#  Default: 1000
12otebookApp.iopub_msg_rate_limit = 1000

## The IP address the notebook server will listen on.
#  Default: 'localhost'
12otebookApp.ip = 'localhost'

## Supply extra arguments that will be passed to Jinja environment.
#  Default: {}
12otebookApp.jinja_environment_options = {}

## Extra variables to supply to jinja templates when rendering.
#  Default: {}
12otebookApp.jinja_template_vars = {}

## The kernel manager class to use.
#  Default: 'notebook.services.kernels.kernelmanager.MappingKernelManager'
12otebookApp.kernel_manager_class = 'notebook.services.kernels.kernelmanager.MappingKernelManager'
...
12otebookApp.kernel_spec_manager_class = 'jupyter_client.kernelspec.KernelSpecManager'

## The full path to a private key file for usage with SSL/TLS.
#  Default: ''
12otebookApp.keyfile = ''
...
#         as local as well.
#  Default: ['localhost']
12otebookApp.local_hostnames = ['localhost']

## The date format used by logging formatters for %(asctime)s
#  See also: Application.log_datefmt
12otebookApp.log_datefmt = '%Y-%m-%d %H:%M:%S'

## The Logging format template
#  See also: Application.log_format
12otebookApp.log_format = '[%(name)s]%(highlevel)s %(message)s'
...
#  Default: False
12otebookApp.log_json = False

## Set the log level by value or name.
#  See also: Application.log_level
12otebookApp.log_level = 30

## 
#  See also: Application.logging_config
12otebookApp.logging_config = {}

## The login handler class to use.
#  Default: 'notebook.auth.login.LoginHandler'
12otebookApp.login_handler_class = 'notebook.auth.login.LoginHandler'

## The logout handler class to use.
#  Default: 'notebook.auth.logout.LogoutHandler'
12otebookApp.logout_handler_class = 'notebook.auth.logout.LogoutHandler'

## The MathJax.js configuration file that is to be used.
#  Default: 'TeX-AMS-MML_HTMLorMML-full,Safe'
12otebookApp.mathjax_config = 'TeX-AMS-MML_HTMLorMML-full,Safe'

## A custom url for MathJax.js.
#          Should be in the form of a case-sensitive url to MathJax,
#          for example:  /static/components/MathJax/MathJax.js
#  Default: ''
12otebookApp.mathjax_url = ''
...
#  Default: True
12otebookApp.open_browser = True
...
#  Default: False
12otebookApp.password_required = False

## The port the notebook server will listen on (env: JUPYTER_PORT).
#  Default: 8888
12otebookApp.port = 8888

## The number of additional ports to try if the specified port is not available
#  (env: JUPYTER_PORT_RETRIES).
#  Default: 50
12otebookApp.port_retries = 50

## DISABLED: use %pylab or %matplotlib in the notebook to enable matplotlib.
#  Default: 'disabled'
12otebookApp.pylab = 'disabled'

## If True, display a button in the dashboard to quit
#          (shutdown the notebook server).
#  Default: True
12otebookApp.quit_button = True

## (sec) Time window used to
#          check the message and data rate limits.
#  Default: 3
12otebookApp.rate_limit_window = 3

## Reraise exceptions encountered loading server extensions?
#  Default: False
12otebookApp.reraise_server_extension_failures = False

## DEPRECATED use the nbserver_extensions dict instead
#  Default: []
12otebookApp.server_extensions = []

## The session manager class to use.
#  Default: 'notebook.services.sessions.sessionmanager.SessionManager'
12otebookApp.session_manager_class = 'notebook.services.sessions.sessionmanager.SessionManager'

## Instead of starting the Application, dump configuration to stdout
#  See also: Application.show_config
12otebookApp.show_config = False

## Instead of starting the Application, dump configuration to stdout (as JSON)
#  See also: Application.show_config_json
12otebookApp.show_config_json = False
...
#  Default: 0
12otebookApp.shutdown_no_activity_timeout = 0
...
#  Default: '0600'
12otebookApp.sock_mode = '0600'

## Supply SSL options for the tornado HTTPServer.
#              See the tornado docs for details.
#  Default: {}
12otebookApp.ssl_options = {}
...
#  otherwise.
#  Default: {}
12otebookApp.terminado_settings = {}
...
#           is not available.
#  Default: True
12otebookApp.terminals_enabled = True
...
#  Default: True
12otebookApp.use_redirect_file = True

## DEPRECATED, use tornado_settings
#  Default: {}
12otebookApp.webapp_settings = {}
...
#  Default: 2
12otebookApp.webbrowser_open_new = 2
...
#  Default: None
12otebookApp.websocket_compression_options = None
